...
class EfficientDet_obj2D_ModelWrapper(ModelWrapper):
    ...
    Custom model wrapper class to setup the current process regarding a 2D object detection task using EfficientDet as the network architecture.
    """
    ...
    def set_batch(self, batch):
        r"""
        In this method the incoming batch from the dataset is processed. If the batch is wrongly used, i.e. by using a wrong key for the dictionary, it will throw an error and terminate.
    ...
    def set_loss_function(self):
        r"""
        Setting the loss function for the 2D object detection task. In this case a mix of the FocalLoss for the classification branch and the SmoothL1 loss for the regression part is used.
    ...
    def set_optimizer(self):
        r"""
        Initializing of the optimizer. In this case it is the Adam optimizer with wight decay. Required information that needs to be defined in the configuration file is the start point of the learning rate.
